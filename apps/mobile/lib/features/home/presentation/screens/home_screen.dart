...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    _reminderDays = widget.currentUser.reminderDays;
  ...
  void didUpdateWidget(covariant HomeScreen oldWidget) {
    ...
    if (oldWidget.currentUser.notificationsEnabled !=
            widget.currentUser.notificationsEnabled ||
        oldWidget.currentUser.reminderDays != widget.currentUser.reminderDays) {
      _notificationsEnabled = widget.currentUser.notificationsEnabled;
      _reminderDays = widget.currentUser.reminderDays;
    }
  ...
  Future<void> _saveReminderSettings() async {
    ...
    final result = await widget.authRepository.updateCurrentUser(
      ...
      birthday: widget.currentUser.birthday,
      preferredCurrencyCode: widget.currentUser.preferredCurrencyCode,
