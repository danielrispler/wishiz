...
| `api` | `wishiz-api` service | no | applinks, health, auth, wishlists, uploads, discover read routes, import enqueue (+ Cloud Tasks dispatch). No scrape engine, no loops, no maintenance route |
